...
const environmentId = 'ff8d8830-a601-4182-a471-cd2132742e1e'; // available on settings page of p14c admin console
const clientId = '2dc6b280-c751-463e-ae9e-fd0569f9eb10'; // available on connections tab of admin console
const baseUrl = 'https://csr.tu.demoenvi.com/'; // URL of where you will host this application
